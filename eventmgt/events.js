...
(function () {
  ...
  async function getContext() {
    return new Promise(async (resolve) => {
      ...
      try {
        ...
        console.warn("User email fallback:", userEmail);
      }
  ...
  $(document).ready(async function () {
    ...
    try {
      ...
      console.log("FULL CONTEXT READY:", { site: ctx.site, user: ctx.userEmail });
        ...
        register(id) {
          ...
          this.getRegCount(id).then(count => {
            ...
            if (!full) this.createReg(id, 'Confirmed', null, ev.Title);
              ...
              if (confirm(`Event full. Join waitlist #${pos}?`)) this.createReg(id, 'Waitlisted', pos, ev.Title);
            });
          });
        }
